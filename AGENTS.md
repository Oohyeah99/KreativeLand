...
| **Vercel Deploy** | See quest-specific AGENTS.md | Deploying frontend apps to Vercel (VocabVista has detailed rules in its AGENTS.md) |

**Rule:** If your task involves Microsoft To Do, the office PC, git operations, the Azure VM, or Vercel deployment, read the relevant skill BEFORE starting. Do NOT rely on memory or attempt from scratch.
